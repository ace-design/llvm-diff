...
class FunctionDifferenceEngine {
  ...
  /* Sorts pairs of unified blocks, this happens after unification */
  struct QueueSorter {
  ...
  /* Unifies L with R if L is not already unified with someone else */
